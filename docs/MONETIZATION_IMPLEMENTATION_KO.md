...
- 생성 조건은 게스트 최대 2개, 무료회원 최대 5개, Pro는 제한 없이 선택한다.
- 조건 직접 선택과 번호 생성은 각 등급의 한도 안에서 이용한다.
- 과거 분포의 넓은 범위를 한 번에 적용하는 균형 프리셋은 Pro에서 이용한다.
...
```text
guest
  조합 2개 / 조건 2개 / 결과 광고 / 저장 불가

free
  조합 5개 / 조건 5개 / 결과 광고 / 기기 저장

pro
  조합 5개 / 조건 무제한·균형 프리셋 / 광고 제거 / AI·비교·Custom / 클라우드 저장
```
