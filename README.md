...
앱의 분석은 번들된 정적 데이터를 오프라인 기준으로 사용하고, Firebase에 검증된 최신 회차가 있으면 이를 합쳐 계산합니다. 동행복권 조회는 사용자 기기가 아니라 주 1회 Firebase 예약 함수에서만 수행합니다.
...
자동 동기화 일정, 데이터 검증, 신규 회차 안내와 배포 방법은 [로또 당첨 데이터 자동 동기화](./docs/LOTTO_DATA_SYNC_KO.md)에 정리되어 있습니다.
